    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Shivam S. Ramoliya</h1>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Passionate Developer,<br/> love to craft<br/><span className="text-blue-500">Scalable web applications </span></h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Expertise in React.js, <br/><span className="text-purple-500">Node.js</span> & Cloud.</h2>
            </div>
        </motion.div>
    </div>
  );
